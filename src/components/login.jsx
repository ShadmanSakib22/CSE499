    ...
    <div>
      ...
      <main className="w-full h-screen flex self-center place-content-center place-items-center pt-[5rem] pb-[2rem] bg-brown-50 ">
        <div className="w-96 text-gray-600 space-y-5 p-4 px-10 shadow-xl  rounded-xl bg-white border-4 border-double border-brown-100">
          <h1 className="text-3xl pt-5 font-bold">Welcome Back!</h1>
          <form onSubmit={onSubmit} className="space-y-5">
            ...
            <div>
              <input
                ...
                className="w-full my-2 px-3 py-2 text-gray-500 bg-transparent outline-none border focus:border-indigo-600 shadow-sm rounded-lg transition duration-300"
              />
            </div>
          ...
          <Link
            to={"/login"}
            className="text-center text-sm hover:underline text-blue-300"
          >
            Forgotten Password?
          </Link>
