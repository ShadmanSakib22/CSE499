      ...
      {username ? (
        <div className="text-gray-600 space-y-5 p-4 px-10 shadow-xl rounded-xl bg-white border-4 border-double border-brown-100 w-4/5">
          <div className="bg-brown-400 rounded-r-full border-brown-50 border-2 shadow-sm shadow-brown-500 mt-4">
            <h1 className="text-3xl font-bold text-white p-1 ml-2">Subscribe</h1>
          </div>
          <br />
          <span className="text-lg my-4 py-2 px-6 border-2 border-brown-100 rounded-xl">
          Logged in as,{" "}
          ...
          <div className="relative max-w-7xl mx-auto">
            <div className="max-w-lg mx-auto rounded-lg shadow-lg overflow-hidden lg:max-w-none lg:flex">
              <div className="flex-1 px-6 py-8 lg:p-12 bg-brown-800">
                <h3 className="text-2xl font-extrabold text-white sm:text-3xl">Premium Early Access!</h3>
                <p className="mt-6 text-base text-gray-50 sm:text-lg">
                Subscribe to the Techsolutions Premium Package to recieve Specialized Support.
                </p>
                <div className="mt-8">
                  ...
                  >
                    <li className="flex items-start lg:col-span-1">
                      ...
                      <p className="ml-3 text-white">Get Unlimited Forum Access</p>
                    </li>
                    <li className="flex items-start lg:col-span-1">
                      <div className="flex-shrink-0">
                        <svg
                      ...
                      <p className="ml-3 text-white">Early Access to New Updates</p>
                    </li>
                    <li className="flex items-start lg:col-span-1">
                      <div className="flex-shrink-0">
                        <svg
